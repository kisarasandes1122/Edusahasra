const translations = {
  en: {
    ...
    step1Label: "School Info", 
    step2Label: "Address", 
    step3Label: "Location", 
    step4Label: "Principal", 
    step5Label: "Verification", 
  },
  si: {
    ...
    uploadedFilesTitle: "උඩුගත කළ ගොනු", 
    ...
    submittingButton: "ඉදිරිපත් කරමින්...", 
    nextButton: "ඊළඟ", 
    previousButton: "පෙර", 
    step1Label: "පාසල් තොරතුරු", 
    step2Label: "ලිපිනය", 
    step3Label: "ස්ථානය", 
    step4Label: "විදුහල්පති", 
    step5Label: "සත්‍යාපනය", 
  }
};
